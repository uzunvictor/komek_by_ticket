<div class="sm:!hidden fixed inset-0 flex flex-1 flex-col -translate-x-[100%] bg-[#123D4B] transition duration-300 ease-in z-1000"
    ...
    <div class="flex flex-col flex-1">
        ...
        <div class="relative flex flex-col gap-4 justify-center sm:justify-between items-center px-[50px] pt-[19px] pb-[23px] border-t border-[#A0AEB7]">
            <div class="flex gap-4 items-center">
                <a href="https://www.facebook.com/groups/worldcinemagroup/" target="_blank">
                    <x-icon-facebook></x-icon-facebook>
                </a>
            ...
            <button id="closeMobileMenuBtn"
                 class="absolute bottom-8 right-[10px] cursor-pointer h-10 w-10 flex justify-center items-center animate-pulse active:animate-bounce">
